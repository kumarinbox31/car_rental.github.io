...
<head>
	...
	<title>Car Rental Portal | Car Owner Dashboard</title>
...
$sql ="SELECT id from booking_request where CarNumber LIKE '%{$VehicleNumber}%' ";
...
?>
													...
													<div class="stat-panel-title text-uppercase">Booking Requests</div>
												</div>
											</div>
											<a href="manage-booking_request.php" class="block-anchor panel-footer">Full Detail <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
...
<?php 
$VehicleNumber=$_SESSION['blogin'];
$sql2 ="SELECT id from booking where CarNumber LIKE '%{$VehicleNumber}%' ";
...
?>
													...
													<div class="stat-panel-title text-uppercase">My Bookings</div>
												</div>
											</div>
