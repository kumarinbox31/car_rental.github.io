...
$id=$_GET['VehicleNumber'];

$sql="UPDATE tblcars SET BrandName=:BrandName,OwnerMobile=:OwnerMobile,VehicleNumber=:VehicleNumber,OwnerName=:OwnerName,
Address=:Address,DriverMobile=:DriverMobile WHERE VehicleNumber=:VehicleNumber";
...
<body>
	...
	<?php include('includes/leftbar.php');?>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Change Car Details</h2>
  	        	  ...
  	        	  <?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
											...
											<div class="form-group">
												<label class="col-sm-4 control-label" for="BrandName">Brand Name</label>
		...
		$sql ="SELECT * from tblcars where VehicleNumber LIKE '%{$VehicleNumber}%' ";
		$query = $dbh -> prepare($sql);
		$query->execute();
		$results=$query->fetchAll(PDO::FETCH_OBJ);
...
?>
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" class="form-control" name="OwnerName" id="OwnerName"  value="<?php echo htmlentities($result->OwnerName);?>" required>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" class="form-control" name="OwnerMobile" id="OwnerMobile"  value="<?php echo htmlentities($result->OwnerMobile);?>"  required>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" class="form-control" name="DriverMobile" id="DriverMobile"  value="<?php echo htmlentities($result->DriverMobile);?>"  required>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<?php $VehicleNumber=$_SESSION['blogin']; ?>
												<input type="text" class="form-control" value="<?php echo htmlentities($VehicleNumber);?>" name="VehicleNumber" id="VehicleNumber" required>
												</div>
											</div>
											<div class="hr-dashed"></div>
