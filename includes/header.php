...
foreach($results as $result)
	{
	 ...
	 echo htmlentities($result->FullName); }}?><i class="fa fa-angle-down" aria-hidden="true"></i></a>
          ...
          <li><a href="my-cars.php">Booking Request</a></li>
          ...
          <li><a href="#loginform"  data-toggle="modal" data-dismiss="modal">Booking Request</a></li>
 ...
 <?php if($_SESSION['login']){?>
    <li><a href="my-cars.php">Book Cars </a></li>
    <?php } else { ?>
      <li><a href="#loginform">Book Cars </a></li>
      <?php } ?>
        </ul>
      </div>
    </div>
