			...
			<div class="container-fluid">
				...
				<div class="row">
  	        	  ...
  	        	  <?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
											...
											<select id="CarNumber" name="CarNumber" style='margin:0 20' required>
											<?php $ret="select VehicleNumber from tblcars";
                                                ...
                                                {
                                                ?>
                                                <option value="<?php echo htmlentities($result->VehicleNumber);?>"><?php echo htmlentities($result->VehicleNumber);?></option>
                                                <?php }} ?>
											</select>
											<br>
                                            <br>
