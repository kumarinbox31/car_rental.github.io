...
if(isset($_GET['bid'])){
	...
	$sql="INSERT INTO  booking(CarNumber,Date,Time,FullName,MobileNumber,Address,status) 
	VALUES(:CarNumber,:date,:time,:FullName,:MobileNumber,:Addres,1)";
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Manage Booking Requests
						</h2>
...
<?php $sql = "SELECT * from  booking_request ";
...
$sql = "SELECT status from  booking";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
